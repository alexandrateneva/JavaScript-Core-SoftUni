function getProcessToAchiveTargetThickness(input) {
...
getProcessToAchiveTargetThickness([1375, 50000]);

getProcessToAchiveTargetThickness([1000, 4000, 8100]);