class Task {
    ...
    set deadline(value) {
        if (value < Date.now()) {
            throw Error('Deadline cannot be past date.');
        }
    ...
    static comparator(a, b) {
        if (a.isOverdue === true && b.isOverdue === false) return -1;
        if (a.isOverdue === false && b.isOverdue === true) return 1;

        if (a.isOverdue === true && b.isOverdue === true) return a.deadline - b.deadline;
