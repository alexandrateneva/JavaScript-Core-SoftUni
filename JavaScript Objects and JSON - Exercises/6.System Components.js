function createRegisterForSystemComponents(input) {
    let systems = new Map();
    for (let componentInfo of input) {
        let [system, component, subcomponent] = componentInfo.split(' | ');
...
createRegisterForSystemComponents(['SULS | Main Site | Home Page',
